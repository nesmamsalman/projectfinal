      ...
      child: Column(
        children: <Widget>[
          ...
          FriendsListTile(
            ...
            title: "Anabel",
            subtitle1: "50 reviews",
            buttonText: "Follow",
          ),
          FriendsListTile(
            imageUrl: ImagePath.andy,
            title: "Andy",
            subtitle1: "12 reviews",
            buttonText: "Unfollow",
            isFollowing: false,
          ),
          FriendsListTile(
            ...
            title: "Branson",
            subtitle1: "29 reviews",
            buttonText: "Follow",
          ),
          FriendsListTile(
            imageUrl: ImagePath.juliet,
            title: "Juliet",
            subtitle1: "34 reviews",
            buttonText: "Unfollow",
            isFollowing: false,
          ),
        ],
      ...
      child: Column(
        children: <Widget>[
          ...
          FriendsListTile(
            ...
            title: "John",
            subtitle1: "21 reviews",
            buttonText: "Follow",
          ),
          FriendsListTile(
            imageUrl: ImagePath.deven,
            title: "Deven",
            subtitle1: "43 reviews",
            buttonText: "Follow",
          ),
          FriendsListTile(
            imageUrl: ImagePath.duke,
            title: "Duke",
            subtitle1: "92 reviews",
            buttonText: "Follow",
          ),
          FriendsListTile(
            imageUrl: ImagePath.ashlee,
            title: "Ashlee",
            subtitle1: "89 reviews",
            buttonText: "Follow",
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      ...
      title: Container(
        ...
        child: Text(
          title,
          style: textTheme.bodyText1.copyWith(fontSize: Sizes.TEXT_SIZE_20),
        ),
      ),
      subtitle: Text(
        subtitle1,
