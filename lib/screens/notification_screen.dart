...
class NotificationsScreen extends StatelessWidget {
  ...
  List<NotificationInfo> notifications = [
    NotificationInfo(
      ...
      time: "5:30 am",
      subtitle1: "Started following you",
    ),
    NotificationInfo(
      imageUrl: ImagePath.juliet,
      title: "Juliet Hooper",
      time: "Yesterday",
      subtitle1: "Checked in at Happy Bones",
    ),
    NotificationInfo(
    ...
    NotificationInfo(
      ...
      title: "Anabel Leach",
      time: "26/05/2019",
      subtitle1: "Checked in at Uncle Booons",
    ),
    NotificationInfo(
    ...
    NotificationInfo(
      ...
      title: "Duke Carter",
      time: "16/05/2019",
      subtitle1: "Checked in at Miller's Cafe",
    ),
    NotificationInfo(
    ...
    NotificationInfo(
      ...
      title: "Filip Hracek",
      time: "26/05/2019",
      subtitle1: "Checked in at McDonald's",
    ),
    NotificationInfo(
      imageUrl: ImagePath.duke,
      title: "John Mark",
    ...
    NotificationInfo(
      ...
      title: "David Legend",
      time: "19/11/2019",
      subtitle1: "Checked in at Vancouver Cafe",
    ),
  ];
